...
class ServiceSummaryScreen extends Component {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={{padding: 10}}>
          <StepIndicator
            stepCount={4}
            labels={["Serviço", "Horário", "Confirmar", "Recibo"]}
            currentPosition={2}
        ...
        <View style={{padding: 20}}>
          <TouchableOpacity>
            <View style={{borderRadius: 5, flexDirection: 'row', backgroundColor: '#2F9084', margin: 5, justifyContent: 'center', alignItems: 'center', height: 40, bottom: 10}}>
...
export default connect(mapStateToProps, { skipped })(ServiceSummaryScreen)